...
df = pd.read_csv('results/optimization_results_neuflow.csv')
...
plt.suptitle('Hyperparameter Slice Plot (Optical tracking)', y=1.05, fontsize=18, fontweight='bold')
plt.tight_layout()
...
plt.savefig('results/plots/slice_plot_neuflow.png', dpi=300, bbox_inches='tight', transparent=True)